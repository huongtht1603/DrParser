Feature: As a user I can be taken to the top of the page when clicking on back to top button on all pages
 
	  Scenario: TC_23 In Artificial Intelligence page, Verify function of back to top button
	  ...
	  Scenario: TC_27 In Business Intelligence page, Verify function of back to top button
	  	Given Be on Business Intelligence page
	  	When Click on back to top button
	  	Then I am taken to the top of the Business Intelligence page
	  	

	  Scenario: TC_31 In Data Engineering page, Verify function of back to top button
	  	Given Be on Data Engineering page
	  	When Click on back to top button
	  	Then I am taken to the top of the Data Engineering page

	  Scenario: TC_35 In Data Science and Analytics Solutions page, Verify function of back to top button
	  ...
	  Scenario: TC_39 In Company page, Verify function of back to top button
	  	Given Be on Company page
	  	When Click on back to top button
	  	Then I am taken to the top of the Company page
	  	
	  		  		
	  Scenario: TC_52 In Blog page, Verify function of back to top button
	  	Given Be on Blog page
	  	When Click on back to top button
	  	Then I am taken to the top of the Blog page
	  	

	  Scenario: TC_59 In Careers page, Verify function of back to top button
	  	Given Be on Careers page
	  	When Click on back to top button
	  	Then I am taken to the top of the Careers page
	  	

	  Scenario: TC_69 In DrParser product page, Verify function of back to top button
	  	Given Be on DrParser product page
	  	When Click on back to top button
	  	Then I am taken to the top of the DrParser product page
	  	
	  
	  Scenario: TC_94 In Demo DrParser product page, Verify function of back to top button
	  	Given Be on Demo DrParser product page
	  	When Click on back to top button
	  	Then I am taken to the top of the Demo DrParser product page
	  	

	  Scenario: TC_120 In packages page, Verify function of back to top button
